...
export const getTodos = async () => {
  try {
    const response = await axios.get("http://13.124.200.126/api/todo", {
...
export const getTodo = async (id) => {
  try {
    const response = await axios.get(`http://13.124.200.126/api/detail/${id}`, {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
...
export const postTodo = async (todo) => {
  try {
    await axios.post("http://13.124.200.126/api/todo", todo, {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
    console.log(todo);
...
export const changeTodo = async (id, todo) => {
  try {
    await axios.put(`http://13.124.200.126/api/detail/${id}`, todo, {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
  } catch (error) {
...
export const deleteTodo = async (id) => {
  try {
    await axios.delete(`http://13.124.200.126/api/todo/${id}`, {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
  } catch (error) {
...
export const completeTodo = async (id) => {
  try {
    await axios.patch(`http://13.124.200.126/api/todo/${id}`, {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
  } catch (error) {
...
export const getCompleteTodos = async () => {
  try {
    const response = await axios.get("http://13.124.200.126/api/", {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
...
export const logout = async () => {
  try {
    await axios.post("http://13.124.200.126/api/logout", {
      headers: { Authorization: document.cookie.split("=")[1] },
    });
  } catch (error) {
...
export const signUp = async (userInfo) => {
  try {
    await axios.post("http://13.124.200.126/api/signup", userInfo);
  } catch (error) {
